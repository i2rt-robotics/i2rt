...
def main(argv: Optional[List[str]] = None) -> None:
    ...
    p.add_argument("--engage-thr", type=float, default=0.35, help="rad; both leaders past this from home → ENGAGE")
    p.add_argument("--release-thr", type=float, default=0.15, help="rad; both leaders within this of home → home")
